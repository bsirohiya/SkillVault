                    ...
                    <div className='flex flex-col md:flex-row items-start justify-between'>
                        <div>
                            <div className='flex items-center gap-3'>
                                <h1 className='text-2x1 font-bold text-gray-900'>{user.
                                    full_name}</h1>
                        ...
                        {/* If user is not on others profile that means he is opening his/her profile so we will give edit button */}
                        {
                            !profileId &&
                ...
                text-gray-500 mt-4'>
                    ...
                    <div className='flex items-center gap-6 mt-6 border-t border-gray-200 pt-4'>
                        ...
                        <div>
                            ...
                            <span className=' text-xs sm:text-sm ml-1 text-gray-600'>Posts</span>
                        </div>
                        <div>
                            <span className='sm:text-xl font-bold text-gray-900'>{user.followers.length}</span>
                            <span className=' text-xs sm:text-sm ml-1 text-gray-600'>Followers</span>
                        </div>
                        <div>
                            <span className='sm:text-xl font-bold text-gray-900'>{user.following.length}</span>
                            <span className=' text-xs sm:text-sm ml-1 text-gray-600'>Following</span>
                        </div>
